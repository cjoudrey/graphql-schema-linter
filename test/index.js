...
require('./rules/enum_values_sorted_lexicographically');
...
require('./rules/input_object_fields_sorted_lexicographically');
...
require('./rules/type_fields_sorted_lexicographically');
